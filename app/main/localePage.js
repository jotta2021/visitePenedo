...
const LocalePage = () => {
  ...
  const [message, setMessage] = useState(
    "Olá, gostaria de informações sobre reserva."
  );
  ...
  const openWhatsApp = () => {
    ...
    const whatsappLink = `https://wa.me/${formatPhoneNumber(
      selectItem.internationalPhoneNumber
    )}?text=${encodedMessage}`;
        ...
        <View>
          ...
          <View style={styles.content}>
            ...
            {selectItem.regularOpeningHours && (
              <View>
                <View style={styles.status}>
                  <View
                    style={
                      selectItem.regularOpeningHours.openNow === true
                        ? styles.circle
                        : styles.circleClose
                    }
                  ></View>
                ...
                <TouchableOpacity
                  style={styles.containerOpenHours}
                  onPress={() => router.push("/main/Hours")}
                >
                  <Text style={styles.openHours}>Verificar horários</Text>
                  <ArrowIcon name="arrow-forward-ios" size={18} />
                </TouchableOpacity>
              </View>
            )}
            ...
            <View style={styles.containerButton}>
              ...
              {selectItem.location && selectItem.location !== "" && (
                <Button
                  buttonStyle={styles.buttonLocale}
            ...
            <View style={styles.ratingContainer}>
              ...
              >
                {selectItem.reviews && selectItem.reviews.length > 0 ? (
                  <FlatList
                    data={selectItem.reviews}
                    keyExtractor={(item, index) => index.toString()}
                    renderItem={({ item }) => <Reviews data={item} />}
                  />
                ) : (
                  <Text>Sem avaliações no momento</Text>
                )}
              </View>
            </View>
          </View>
        ...
        >
          <View style={styles.modal}>
            ...
            <View>
              ...
              />
              <Button
                buttonStyle={[styles.buttonLocale, { marginTop: 10 }]}
